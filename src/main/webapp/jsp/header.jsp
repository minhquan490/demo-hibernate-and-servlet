                                ...
                                <li class="header__navbar-item header__navbar-user">
                                    ...
                                    <ul class="header__navbar-user-menu">
                                        ...
                                        <c:if test="${sessionScope.user.roleId == 1}">
                                            <li class="header__navbar-user-item">
                                                <a href="${pageContext.request.contextPath}/Admin" class="link">Admin Page</a>
                                            </li>
                                        </c:if>
                        ...
                        <a href="${pageContext.request.contextPath}/welcome" class="header__logo-link">
                            <svg class="header__logo-img" viewBox="0 0 400 130">
                                <g fill-rule="evenodd">
                                    ...
                                    <path d="M339.501 50.332 C 339.029 50.805,338.974 61.633,339.442 62.021 C 339.667 62.208,341.153 62.251,347.484 62.256 C 355.373 62.262,355.667 62.283,355.667 62.829 C 355.667 63.103,354.009 66.475,353.654 66.924 C 353.493 67.127,351.312 71.194,348.921 75.750 C 348.488 76.575,347.962 77.550,347.752 77.917 C 347.087 79.078,345.470 82.039,344.839 83.250 C 344.144 84.583,343.248 86.227,342.295 87.917 C 341.933 88.558,341.532 89.308,341.405 89.583 C 341.278 89.858,341.095 90.196,341.000 90.333 C 340.752 90.691,339.394 93.212,338.714 94.578 C 338.035 95.941,337.761 97.928,338.201 98.293 C 338.645 98.662,375.853 98.594,376.123 98.224 C 376.425 97.811,376.426 87.023,376.125 86.615 C 375.935 86.358,375.147 86.330,367.000 86.292 L 358.083 86.250 358.030 85.787 C 357.998 85.505,358.156 85.015,358.433 84.537 C 358.683 84.104,359.538 82.550,360.333 81.083 C 361.128 79.617,362.025 77.967,362.326 77.417 C 362.627 76.867,363.140 75.929,363.466 75.333 C 364.096 74.181,364.290 73.828,365.169 72.250 C 365.475 71.700,366.188 70.350,366.752 69.250 C 367.317 68.150,368.027 66.800,368.330 66.250 C 368.633 65.700,369.084 64.875,369.333 64.417 C 369.582 63.958,370.215 62.796,370.740 61.833 C 371.265 60.871,372.076 59.371,372.542 58.500 C 373.007 57.629,373.863 56.064,374.444 55.023 L 375.500 53.128 375.500 51.665 C 375.500 50.504,375.447 50.182,375.244 50.104 C 374.402 49.781,339.832 50.001,339.501 50.332" fill="#f70808"></path>
                                </g>
                            </svg>
                        </a>
                    </div>
